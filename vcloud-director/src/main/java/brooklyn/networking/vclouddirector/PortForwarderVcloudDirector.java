...
public class PortForwarderVcloudDirector implements PortForwarder {
    ...
    Optional<Network> tryFindNetworkByName(VCloudDirectorApi api, String networkName) {
        return VCloudDirectorComputeUtils.tryFindNetworkNamedInCurrentOrg(api, networkName);
    }

    static Optional<Network> tryFindNetworkById(final VCloudDirectorApi api, final String networkId) {
